    ...
    <div class="container">
        <div class="form_cont">
            <form method="POST" class="form">
                <input type="text" class="input_class" name="name" value="<?= $name ?>" placeholder="Введите имя">
                <input type="email" class="input_class" name="email" value="<?= $email ?>" placeholder="Введите почту">
                <input type="text" class="input_class" name="phone" value="<?= $phone ?>" placeholder="Введите номер телефона">
                ...
                if (isset($_POST['send'])) {
                    ...
                    echo '<p class="noerror">Форма успешно отправлена</p>';
                }
                ?>
            </form>
        </div>
